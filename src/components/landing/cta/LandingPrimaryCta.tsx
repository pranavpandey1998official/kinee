...
const LandingPrimaryCtaContent = ({
  ...
  return (
    ...
    >
      ...
      {title ? (
        <h1 className="text-2xl lg:text-4xl leading-tight font-semibold font-mono">
          {title}
        </h1>
      ) : (
        titleComponent
...
export const LandingPrimaryImageCtaSection = ({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "w-full p-6 flex flex-col gap-8 relative pl-4",
          imagePosition === "center"
            ? "container-ultrawide"
            : "max-w-full container-ultrawide grid lg:grid-cols-2 items-center",
        ...
        {imageSrc ? (
          <>
            ...
            {imagePosition === "left" || imagePosition === "right" ? (
              <Image
                className={clsx(
                  "w-full rounded-md relative z-10 max-w-md",
                  imageShadow === "soft" && "shadow-md",
                  imageShadow === "hard" && "hard-shadow",
